        ...
        case CONSTANT_Float:
            ...
            default:
                ...
                else
                {
                    ...
                    int32_t m = (e == 0) ? (bits32 & 0x7fffff) << 1 : (bits32 & 0x7fffff) | 0x800000;
        ...
        case CONSTANT_Double:
            ...
            default:
                ...
                else
                {
                    ...
                    int64_t m = (e == 0) ? (bits64 & 0xfffffffffffffL) << 1 : (bits64 & 0xfffffffffffffL) | 0x10000000000000L;
    ...
    for (uint16_t i = 0; i < attributes_count; i++)
    {
        ...
        case INNER_CLASSES:
            ...
            for (uint16_t i = 0; i < attributes_aux->u.InnerClasses.number_of_classes; i++)
            {
                ...
                printConstantClass(cf, cf->constant_pool + (classes_aux)->inner_class_info_index - 1, saida);
                fprintf(saida, "\n\t\t\t\t\tsuper_class_info_index:\t\tcp_info #%" PRId16 "\t",
                        (classes_aux)->outer_class_info_index);
                printConstantClass(cf, cf->constant_pool + (classes_aux)->outer_class_info_index - 1, saida);
